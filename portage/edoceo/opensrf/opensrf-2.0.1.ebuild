...
HOMEPAGE="http://open-ils.org/opensrf.php"
KEYWORDS="~x86 amd64"
LICENSE="GPL-2"
SLOT="2"
...
>=dev-db/libdbi-0.8.2
net-im/ejabberd[mod_irc,mod_muc,mod_pubsub,pam,ssl,web,zlib]
...
src_configure()
{
	econf --prefix=/openils --with-apxs=/usr/sbin/apxs2 || die "econf failed"
}
...
pkg_config()
{
	...
	ewarn
	ewarn "OpenSRF is installed to /openils"
}
